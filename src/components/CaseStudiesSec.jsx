...
function CaseStudiesSec() {
  return (
    <div className="mainsection w-full  bg-[#fff]">
    <div className="max-w-[1320px] mx-auto min-h-screen flex items-center lg:py-0 py-10 gap-2 flex-col lg:px-0  md:px-8 sm:px-6 px-4">
      <motion.h2 initial={{ opacity: 0, y:50 }}
      whileInView={{ opacity: 1, y:0 }} transition={{duration:1 }} className="text-[42px] font-[800] text-[#000]">
