...
function TestimonialsSection() {
  ...
  return (
    <div id="reviews" className="w-full h-auto py-20">
      <div className="max-w-[1320px] mx-auto text-white pt-5 pb-10 lg:pt-0 flex flex-col items-start lg:px-0 md:px-8 sm:px-6 px-4">
